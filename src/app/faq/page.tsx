  ...
  const locations = [
    {
      ...
      queries: "1000 Queries and Insights",
      color: "bg-[#1E184F]",
    },
    {
      name: "Orchard Road",
      queries: "173 Queries and Insights",
      color: "bg-[#EF2BA0]",
    },
    {
      name: "Jurong East",
      queries: "357 Queries and Insights",
      color: "bg-[#1E184F]",
    },
    {
      name: "Punggol",
      queries: "200 Queries and Insights",
      color: "bg-[#EF2BA0]",
    },
    {
      name: "Tampines",
      queries: "280 Queries and Insights",
      color: "bg-[#1E184F]",
    },
    {
      name: "Woodlands and Yishun",
      queries: "450 Queries and Insights",
      color: "bg-[#EF2BA0]",
    },
  ];
    ...
    <div className=" ">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-8">
          Community Q&A Discussion Forums
        </h1>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {locations.map((location, index) => (
              <div
                key={index}
                className={`${location.color} text-white rounded-2xl p-6`}
              >
                <h3 className="font-medium text-[20px] mb-2">
                  {location.name}{" "}
                </h3>
                <p className="text-[18px] opacity-90">{location.queries}</p>
              </div>
            ))}
          </div>
        </div>
